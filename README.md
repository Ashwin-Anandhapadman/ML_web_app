This Machine learning-based web interface is used for calculating the Fire weather index (FWI) in case of forest fires. The model was trained using the Algerian forest fires dataset. 
